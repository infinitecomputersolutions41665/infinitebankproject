...
const EmpLoanMaster = () => {
    ...
    <div className="container-fluid">
             ...
             <Link to="/HomeLoan" className="navbar-brand">Home</Link>
            ...
            <Link to="HomeLoan/EmpLoanReports"   className="nav-item nav-link">ReportLoan</Link>
