...
const ReportLoan = () => {
  ...
  const filteredLoanData = GetLoanData.filter((loan) =>
    loan.cid.toString() === gicid
  );
        ...
        <div style={styles.formBox}>
          ...
          {filteredLoanData.map((loan, index) => (
            <div key={index}>
              ...
              <Link to={`/HomeCustomer/Loanpay?loanid=${loan.lnaccid}`} style={styles.button}>
                Pay Now
              </Link>&nbsp;&nbsp;
              <Link to={`/HomeCustomer/LoanTrans?loanid=${loan.lnaccid}`} style={styles.button}>
                Loan Transactions
              </Link>
              <hr />
            </div>
